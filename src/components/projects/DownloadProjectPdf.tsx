...
export function DownloadProjectPdf({ project, timeStats }: { project: ProjectData, timeStats: TimeStats }) {
    ...
    return (
        <Button onClick={generatePDF} disabled={isLoading} variant="outline" className="gap-2 bg-gradient-to-r from-gray-800 to-gray-900 text-white border-0 hover:from-gray-700 hover:to-gray-800">
