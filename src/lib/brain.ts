...
import { z } from 'zod'
import { ProjectUpdateSchema, ProjectUpdateData, STAGE_LISTS } from '@/lib/constants'

// Re-export for backward compatibility if needed, but better to update callsites
export { STAGE_LISTS, ProjectUpdateSchema }
